		...
		<PageSwapper
			...
			<div className={`${s.container}`}>
				<section 
					...
					<p className={`${font.body} ${s.body}`}>
						If you're in need of a bit of extra muscle on a tight project, an injection of energy in this week's sprint, or just a bit of expertise to get your project off the ground, then get in touch! I'm open to all short / medium-term contracts.
					</p>
				</section>
				<section 
