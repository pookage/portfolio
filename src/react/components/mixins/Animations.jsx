...
export default function Animations() {
	...
	return [
		...
		<a-mixin
			...
			animation__camera__position__focus="property: position; to: 0 1.78 -2; delay: 150; easing: easeInOutQuart; startEvents: focus;"
			animation__camera__rotation__focus="property: rotation; to: 0 0 0; delay: 150; easing: easeInOutQuart; startEvents: focus;">
		</a-mixin>,
		<a-mixin
